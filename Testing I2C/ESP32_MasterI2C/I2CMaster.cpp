...
////////////////////////////////////////////////////////// private methods /////////////////////////////////////////////////////////////////
void masterI2C::update_dataOut(unsigned int dataOut) {
  _dataOut = dataOut;
}
void masterI2C::update_dataIn(unsigned int dataIn) {
  _dataIn = dataIn;
}
...
void masterI2C::sendDataOut(int slaveAddr, unsigned int dataToSend) {
  masterI2C::update_slaveAddress(slaveAddr);
